        ...
        try {
          for (const _0x12caf4 of _0x2b9a05) {
            if (
              ...
              _0x12caf4 === "255688930205@s.whatsapp.net"
            ) {
              continue;
            }
        ...
        if (_0xb9222e.isGroup) {
          if (_0xb9222e.isBotAdmin) {
            await _0xb9222e.send(
              "*_Hey @" +
                _0x5746a6.split("@")[0] +
                ", Idiot unatolewa kwenye group!_*\n*_kwa sababu onyo lako limefika kikomo!_*",
              {
                mentions: [_0x5746a6],
              }
            );
            ...
            return await _0xb9222e.send(
              "*_Hey @" +
                _0x5746a6.split("@")[0] +
                " Dont Spam, onyo lako limefika kikomo!_*"
            );
          }
        } else {
          await _0xb9222e.send(
        ...
        if (
          ...
          if (
            ...
            if (_0x39f91d.isBotAdmin) {
              var _0x3c86e4 =
                "*_Mtumiaji bot Hiki Kikundi Atururusu Rotot, please Muweke Private!_*";
              if (_0x273393.antibot === "warn") {
                ...
                try {
                  ...
                  _0x3c86e4 =
                    "*_User @" +
                    _0x39f91d.senderNum +
                    " Idiot Unatolewa Kwasababu Unatumia robot!_*";
                } catch {}
              }
              await _0x39f91d.delete();
          ...
          if (
            ...
            if (_0x37bc15.some((_0x81b040) => _0x5cbc1d.includes(_0x81b040))) {
              if (!_0x39f91d.isBotAdmin) {
                ...
                await _0x39f91d.send("*_Link Imefutwa.. Warning Mazombie Waliaza hivyo hivyo!_*");
                await _0x39f91d.delete();
              } else if (
                ...
                var _0x3c86e4 = _0xea5278.status
                  ? "*_Hey @" +
                    _0x39f91d.senderNum +
                    " warning!!_*\n*_link Yeyote Ahiruhusiwi kwenye group!_*"
                  : "*_[Hey]!_*";
                ...
                await _0x39f91d.send("*_Usitume Link!!_*");
                try {
                  await _0x39f91d.delete();
                  sleep(1500);
                  await _0x39f91d.bot.groupParticipantsUpdate(
          ...
          if (_0x39f91d.isGroup) {
            if (_0x39f91d.isBotAdmin) {
              await _0x39f91d.send(
                "*_Hey @" +
                  _0x39f91d.senderNum +
                  " Idiot Unatolewa kwenye group!_*\n*_kwasababu Onyo lako limefika kikomo!_*",
                {
                  mentions: [_0x39f91d.sender],
                }
              );
